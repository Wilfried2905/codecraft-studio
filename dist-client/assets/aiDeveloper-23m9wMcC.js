var m=Object.defineProperty;var h=(a,e,t)=>e in a?m(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var p=(a,e,t)=>h(a,typeof e!="symbol"?e+"":e,t);class y{async analyze(e,t){const s=e.toLowerCase(),i=this.detectIntent(s),n=this.extractRequirements(s,t),r=this.evaluateClarificationNeeds(i,n);return{intent:{...i,needsClarification:r.needed,clarificationQuestions:r.questions},requirements:n}}detectIntent(e){const t=["créer","faire","générer","construire","développer","app","site","application"],s=["modifier","changer","améliorer","ajouter","supprimer","corriger"],i=["comment","pourquoi","qu'est-ce","est-ce que","peux-tu","?"];let n="question",r=0;return t.some(o=>e.includes(o))&&(n="create_app",r=.8),s.some(o=>e.includes(o))&&(n="modify_app",r=.7),i.some(o=>e.includes(o))&&!t.some(o=>e.includes(o))&&(n="question",r=.6),{type:n,confidence:r,detectedFeatures:this.detectFeatures(e),detectedStack:this.detectStack(e),complexity:this.detectComplexity(e),needsClarification:!1,clarificationQuestions:[]}}extractRequirements(e,t){const s={};return e.includes("e-commerce")||e.includes("boutique")||e.includes("shop")?s.appType="e-commerce":e.includes("landing")||e.includes("page d'accueil")?s.appType="landing-page":e.includes("dashboard")||e.includes("tableau de bord")?s.appType="dashboard":e.includes("portfolio")?s.appType="portfolio":e.includes("blog")?s.appType="blog":(e.includes("crm")||e.includes("gestion"))&&(s.appType="crm"),s.features=this.detectFeatures(e),s.stack=this.detectStack(e),e.includes("minimal")?s.design="minimal":e.includes("moderne")||e.includes("animé")?s.design="modern":(e.includes("corporate")||e.includes("professionnel"))&&(s.design="corporate"),s.database=e.includes("base de données")||e.includes("database")||e.includes("db"),s.authentication=e.includes("auth")||e.includes("connexion")||e.includes("login")||e.includes("utilisateur"),t&&t.length>0&&(s.uploadedFiles=t),s}detectFeatures(e){const t=[],s={auth:["authentification","connexion","login","inscription","register"],payment:["paiement","payment","stripe","paypal","checkout"],crud:["crud","créer","modifier","supprimer","gestion"],realtime:["temps réel","realtime","live","instantané"],search:["recherche","search","filtre","filter"],upload:["upload","télécharger","fichier","image"],api:["api","backend","serveur"],responsive:["responsive","mobile","tablette","adaptatif"],seo:["seo","référencement","meta"],analytics:["analytics","statistiques","tracking"]};for(const[i,n]of Object.entries(s))n.some(r=>e.includes(r))&&t.push(i);return t}detectStack(e){const t=["React","TypeScript","Tailwind CSS"];return e.includes("vue")&&t.push("Vue.js"),e.includes("angular")&&t.push("Angular"),e.includes("svelte")&&t.push("Svelte"),e.includes("node")&&t.push("Node.js"),e.includes("express")&&t.push("Express"),e.includes("next")&&t.push("Next.js"),e.includes("supabase")&&t.push("Supabase"),e.includes("firebase")&&t.push("Firebase"),t}detectComplexity(e){const t=this.detectFeatures(e);return t.length<=2?"simple":t.length<=5?"medium":"complex"}evaluateClarificationNeeds(e,t){var i,n;const s=[];return!t.appType&&e.type==="create_app"&&s.push("Quel type d'application voulez-vous créer ? (e-commerce, landing page, dashboard, portfolio, blog, CRM)"),(i=t.features)!=null&&i.includes("payment")&&s.push("Quel système de paiement préférez-vous ? (Stripe, PayPal, ou les deux)"),t.database&&!((n=t.stack)!=null&&n.some(r=>r.includes("Supabase")||r.includes("Firebase")))&&s.push("Voulez-vous utiliser Supabase, Firebase, ou une autre base de données ?"),!t.design&&e.type==="create_app"&&s.push("Quel style de design préférez-vous ? (minimal, moderne/animé, corporate/professionnel)"),{needed:s.length>0,questions:s}}}class v{generateQuestions(e,t){var o,c,d,u,l;const s=[],i={};return!t.appType&&e.type==="create_app"&&(s.push(`📱 **Quel type d'application voulez-vous créer ?**
- E-commerce
- Landing Page
- Dashboard
- Portfolio
...
- Email/Password
- OAuth (Google, GitHub)
- Les deux`),i.authType="both"),(d=t.features)!=null&&d.includes("responsive")||(s.push(`📱 **Compatibilité mobile ?**
- Oui, responsive design
- Desktop uniquement`),i.responsive=!0),((u=t.features)!=null&&u.includes("api")||(l=t.features)!=null&&l.includes("crud"))&&(s.push(`⚙️ **Backend nécessaire ?**
- Oui, avec API REST
...
Génère une application accessible à tous (WCAG 2.1 AAA).`,priority:4}])}selectAgents(e){var s,i,n,r,o;const t=[];return t.push(this.getAgent("architect"),this.getAgent("designer"),this.getAgent("developer")),((s=e.features)!=null&&s.includes("api")||e.database)&&t.push(this.getAgent("backend")),(e.authentication||(i=e.features)!=null&&i.includes("auth"))&&t.push(this.getAgent("security")),((n=e.features)!=null&&n.includes("seo")||e.appType==="landing-page")&&(t.push(this.getAgent("seo")),t.push(this.getAgent("performance"))),(e.target==="mobile"||(r=e.features)!=null&&r.includes("responsive"))&&t.push(this.getAgent("mobile")),((o=e.features)!=null&&o.includes("payment")||e.appType==="e-commerce")&&(t.push(this.getAgent("security")),t.push(this.getAgent("backend"))),t.push(this.getAgent("tester"),this.getAgent("documenter")),t.push(this.getAgent("accessibility")),Array.from(new Set(t)).sort((c,d)=>c.priority-d.priority)}createPlan(e){const t=this.selectAgents(e),s=e.complexity==="complex"?"sequential":"parallel",i=s==="parallel"?30:t.length*10;return{selectedAgents:t,executionMode:s,estimatedTime:i}}async execute(e,t,s="/api/generate"){const i=[];if(e.executionMode==="parallel"){const n=e.selectedAgents.map(o=>this.executeAgent(o,t,s));(await Promise.allSettled(n)).forEach((o,c)=>{o.status==="fulfilled"?i.push(o.value):i.push({agentId:e.selectedAgents[c].id,agentName:e.selectedAgents[c].name,output:`Erreur: ${o.reason}`,executionTime:0,success:!1})})}else for(const n of e.selectedAgents){const r=await this.executeAgent(n,t,s);i.push(r)}return i}async executeAgent(e,t,s){const i=Date.now();try{const n=this.buildPromptForAgent(e,t),r=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({prompt:n,agentId:e.id,agentName:e.name,systemPrompt:e.systemPrompt})});if(!r.ok)throw new Error(`API Error: ${r.status}`);const o=await r.json(),c=Date.now()-i;return{agentId:e.id,agentName:e.name,output:o.code||o.response||"",executionTime:c,success:!0}}catch(n){return{agentId:e.id,agentName:e.name,output:`Erreur: ${n instanceof Error?n.message:"Unknown error"}`,executionTime:Date.now()-i,success:!1}}}buildPromptForAgent(e,t){var i;let s=`Tu es ${e.name}. ${e.role}
...
`,s}mergeResults(e,t){var n,r;const s=e.filter(o=>o.success);if(s.length===0)return`// Erreur: Aucun agent n'a pu générer de code
`;let i=`// ========================================
`;return i+=`// ${((n=t.appType)==null?void 0:n.toUpperCase())||"APPLICATION"} - Généré par CodeCraft Studio
`,i+=`// Stack: ${((r=t.stack)==null?void 0:r.join(", "))||"React + TypeScript + Tailwind"}
`,i+=`// ========================================
...
`}),i}getAgent(e){const t=this.agents.find(s=>s.id===e);if(!t)throw new Error(`Agent '${e}' not found`);return t}getAllAgents(){return this.agents}}class g extends Error{constructor(e,t,s=500,i){super(t),this.code=e,this.message=t,this.statusCode=s,this.details=i,this.name="AppError"}}class f extends g{constructor(e,t){super("VALIDATION_ERROR",e,400,t),this.name="ValidationError"}}function A(a){return a instanceof g?`❌ **${a.name}**

${a.message}${a.details?`

Détails: ${JSON.stringify(a.details,null,2)}`:""}`:a instanceof Error?`❌ **Erreur**

${a.message}`:`❌ **Erreur inconnue**

Une erreur inattendue est survenue.`}function T(a,e){const t=new Date().toISOString(),s=`[${e}]`;console.error(`${t} ${s} Error:`,a),a instanceof g&&(console.error(`  Code: ${a.code}`),console.error(`  Status: ${a.statusCode}`),a.details&&console.error("  Details:",a.details))}function S(a){const e=[],t=[];if(!a||a.trim().length===0)return e.push("Le code généré est vide"),{isValid:!1,errors:e,warnings:t};a.includes("<html")||t.push("Pas de balise <html> détectée"),a.includes("<head")||t.push("Pas de balise <head> détectée"),a.includes("<body")||t.push("Pas de balise <body> détectée");const s=a.match(/<(?!\/)[\w-]+(?:\s[^>]*)?>/g)||[],i=a.match(/<\/[\w-]+>/g)||[],n=s.map(u=>{var l;return(l=u.match(/^<([\w-]+)/))==null?void 0:l[1]}).filter(Boolean),r=i.map(u=>{var l;return(l=u.match(/^<\/([\w-]+)>/))==null?void 0:l[1]}).filter(Boolean),o=["br","hr","img","input","meta","link"],c=n.filter(u=>!o.includes(u||"")&&n.filter(l=>l===u).length>r.filter(l=>l===u).length);c.length>0&&t.push(`Balises potentiellement non fermées: ${c.join(", ")}`),(a.includes("<script>alert")||a.includes("javascript:"))&&t.push("Code JavaScript potentiellement dangereux détecté");const d=(a.match(/style\s*=\s*"/g)||[]).length;return d>10&&t.push(`Beaucoup de styles inline (${d}). Considérez utiliser des classes CSS.`),{isValid:e.length===0,errors:e,warnings:t,sanitized:a}}function C(a){let e=a;return["onerror","onload","onclick","onmouseover"].forEach(s=>{const i=new RegExp(`${s}\\s*=\\s*["'][^"']*["']`,"gi");e=e.replace(i,"")}),e=e.replace(/javascript:/gi,""),e=e.replace(/data:text\/html/gi,""),e}function x(a,e,t){const s=S(a),i={isValid:!0,errors:[],warnings:[]},n={isValid:!0,errors:[],warnings:[]};return{isValid:s.isValid&&i.isValid&&n.isValid,errors:[...s.errors.map(r=>`HTML: ${r}`),...i.errors.map(r=>`CSS: ${r}`),...n.errors.map(r=>`JS: ${r}`)],warnings:[...s.warnings.map(r=>`HTML: ${r}`),...i.warnings.map(r=>`CSS: ${r}`),...n.warnings.map(r=>`JS: ${r}`)],sanitized:C(a)}}function w(a){if(a.isValid&&a.warnings.length===0)return"✅ **Code valide** - Aucun problème détecté";let e="";return a.isValid||(e+=`❌ **Erreurs détectées**

`,a.errors.forEach((t,s)=>{e+=`${s+1}. ${t}
`}),e+=`
`),a.warnings.length>0&&(e+=`⚠️  **Avertissements**

`,a.warnings.forEach((t,s)=>{e+=`${s+1}. ${t}
`})),e}class P{constructor(){p(this,"intentAnalyzer");p(this,"clarificationEngine");p(this,"agentOrchestrator");p(this,"conversationState");this.intentAnalyzer=new y,this.clarificationEngine=new v,this.agentOrchestrator=new b,this.conversationState={awaitingClarification:!1}}async process(e,t){try{if(!e||e.trim().length===0)throw new f("Le prompt ne peut pas être vide");if(e.length>1e4)throw new f("Le prompt est trop long (maximum 10000 caractères)");const{intent:s,requirements:i}=await this.intentAnalyzer.analyze(e,t);return this.conversationState.awaitingClarification?await this.handleClarificationResponse(e):s.type==="question"?{type:"clarification",message:this.generateQuestionResponse(e)}:s.needsClarification?this.requestClarification(s,i):await this.executeGeneration(i)}catch(s){return T(s,"AIDeveloper.process"),{type:"error",message:A(s)}}}requestClarification(e,t){const s=this.clarificationEngine.generateQuestions(e,t);return this.conversationState={awaitingClarification:!0,currentIntent:e,currentRequirements:t},{type:"clarification",message:s.questions.join(`

`),requirements:t}}async handleClarificationResponse(e){if(!this.conversationState.currentRequirements)return{type:"error",message:"Erreur: État de clarification invalide"};const t=this.clarificationEngine.parseUserResponse(e,this.conversationState.currentRequirements);return this.conversationState.awaitingClarification=!1,await this.executeGeneration(t)}async executeGeneration(e){const t=this.agentOrchestrator.createPlan(e),s=this.generatePlanMessage(t,e),i=await this.agentOrchestrator.execute(t,e),n=this.agentOrchestrator.mergeResults(i,e),r=x(n),o=w(r),c=this.generateExecutionMessage(i,e);return{type:"execution",message:s+`

`+c+`

`+o,code:r.sanitized||n,requirements:e,agentResults:i,executionPlan:s}}generatePlanMessage(e,t){var r;const s=t.appType||"Application web",i=((r=t.stack)==null?void 0:r.join(", "))||"React, TypeScript, Tailwind CSS";let n=`✅ **Parfait ! Je vais créer votre ${s}**
...
`;const r=e.reduce((o,c)=>o+c.executionTime,0);return n+=`- Temps total : ${(r/1e3).toFixed(2)}s
`,n+=`
💻 **Code généré :**
...
Que voulez-vous créer aujourd'hui ? 🚀`:`Je suis prêt à créer votre application ! Décrivez-moi ce que vous voulez, ou demandez de l'aide en tapant "aide" ou "comment ça marche".`}resetState(){this.conversationState={awaitingClarification:!1}}}export{P as AIDeveloper};
//# sourceMappingURL=aiDeveloper-23m9wMcC.js.map
